  ...
  return (
    ...
    `}
      ...
      <div className='flex'>
        <Navbar />
        <div >
        <div className='ml-30 pop text-5xl font-bold'>Discover people</div>
        <div className='grid grid-cols-3 ml-60 pb-15'>
...
<img src={DummyUser}alt="" className='w-20 h-20 rounded-full object-cover'/>
            </div>
            <div className='bg-white-200 w-80 h-40 ml-10 rounded-b-2xl '>
                <div className='text-2xl font-semibold pop mt-2 text-center'>Robert Baratheon</div>
                <div className='text-xl pop font-normal text-gray-400 text-center'>@Robert_Baratheon</div>
         ...
         <div className='flex flex-col transform hover:scale-105 duration-300'>
            <div className='bg-gradient-to-b from-[#5e52e8] to-white w-80 h-30 rounded-t-2xl ml-10 mt-10 flex justify-center items-center'>
<img src={DummyUser}alt="" className='w-20 h-20 rounded-full object-cover'/>
            </div>
            <div className='bg-white-200 w-80 h-40 ml-10 rounded-b-2xl '>
                <div className='text-2xl font-semibold pop mt-2 text-center'>Jash Nik</div>
                <div className='text-xl pop font-normal text-gray-400 text-center'>@jashunik9</div>
                <div className='flex justify-center mt-10'>
                    <button className='text-normal text-white bg-indigo-700 rounded-2xl font-semibold pop w-30 h-12 ml-4 transform hover:scale-105 duration-300 hover:bg-indigo-600 mt-2'>Follow</button>
                    <button className='text-normal bg-indigo-100 text-indigo-700 rounded-2xl font-semibold pop w-30 h-12 ml-4 transform hover:scale-105 duration-300 hover:bg-white mt-2'>Message</button>
...
<img src={DummyUser}alt="" className='w-20 h-20 rounded-full object-cover'/>
            ...
            <div className='bg-white-200 w-80 h-40 ml-10 rounded-b-2xl '>
                <div className='text-2xl font-semibold pop mt-2 text-center'>Dexter Morgan</div>
                <div className='text-xl pop font-normal text-gray-400 text-center'>@BayharbourButcher</div>
                <div className='flex justify-center mt-10'>
                    <button className='text-normal text-white bg-indigo-700 rounded-2xl font-semibold pop w-30 h-12 ml-4 transform hover:scale-105 duration-300 hover:bg-indigo-600 mt-2'>Follow</button>
                    <button className='text-normal bg-indigo-100 text-indigo-700 rounded-2xl font-semibold pop w-30 h-12 ml-4 transform hover:scale-105 duration-300 hover:bg-white mt-2'>Message</button>
