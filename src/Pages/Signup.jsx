  ...
  return (
    ...
    `}
            ...
            <div className=' bg-slate-900 flex justify-center items-center animation'>
                <div className=' w-[35vw] h-[88vh] mt-[15vh] mb-[15vh] rounded-3xl shadow-2xl fade-in'>
                    ...
                    <div className='pop font-semibold text-white text-5xl  text-center'>Signup</div>
                     <div className='flex flex-col items-center'>
                    <input type="text" placeholder='Username' className='mt-10  pl-4 bg-gray-100/15 w-90 h-17 rounded-4xl placeholder:text-xl  placeholder-indigo-200/70' />
                    <input type="text" placeholder='Email' className='mt-5  pl-4 bg-gray-100/15 w-90 h-17 rounded-4xl placeholder:text-xl  placeholder-indigo-200/70' />
                    ...
                    <button className='h-15 w-80  mt-10 text-indigo-500 pop text-2xl font-medium shadow-2xl bg-white rounded-4xl transform hover:scale-105 transition-transform duration-300 focus:ring-4 focus:ring-white/50 focus:outline-none'>Signup</button>
